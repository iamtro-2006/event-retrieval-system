"""Backend-agnostic embedding collection utilities.

Extracted from `indexer/faiss/index_builder.py` so that any indexer backend
can reuse the same embedding/metadata loading logic without depending on a
specific vector DB library.
"""
